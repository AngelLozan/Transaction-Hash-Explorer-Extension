...
var labelResults = document.querySelector(".labelResults");
var feeSpent = document.querySelector('.feeSpent'); // in USD
...
function getTimeTitle() {
  ...
  x.className = "show"; // After 1.5 seconds, remove the show class from DIV
